...
ALL_REPOS = [
  ...
  Repository.new(eclipse_repo_root, 'nano',                paths['nano'],                'org.eclipse.virgo.nano',          nil, ripple_branch, 'clean clean-integration test package publish-ivy publish-multiple-nano-packages-build'),
