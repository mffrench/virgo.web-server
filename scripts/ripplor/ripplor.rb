...
ALL_REPOS = [
  ...
  Repository.new(eclipse_repo_root, 'kernel',              paths['kernel'],              'org.eclipse.virgo.kernel', nil,        'test package publish'),
  ...
  Repository.new(eclipse_repo_root, 'web-server',          paths['web-server'],          nil, nil,                               'clean clean-integration test package smoke-test publish')
]
