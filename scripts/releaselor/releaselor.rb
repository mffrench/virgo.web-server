...
ALL_REPOS = [
  ...
  Repository.new(eclipse_repo_root, 'kernel',              paths['kernel'],              'org.eclipse.virgo.kernel',          bundle_version,  'test package publish publish-package-eclipse-build publish-package-eclipse-download', args[:remote_user]),
  ...
  Repository.new(eclipse_repo_root, 'documentation',       paths['documentation'],       'org.eclipse.virgo.documentation',   bundle_version,  'doc publish publish-package-eclipse-download', args[:remote_user]),
  Repository.new(eclipse_repo_root, 'web-server',          paths['web-server'],          nil,                                 bundle_version,  'test package smoke-test publish publish-package-eclipse-build publish-package-eclipse-download', args[:remote_user])
]
